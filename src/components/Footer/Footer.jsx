    ...
    <footer id="contact" className="footer">
      <div className="footer-content">
        ...
        <div className="social-links">
          <a href="https://www.instagram.com/sungaural/?igsh=d2x4aHpnMWdhZW54#" target="_blank" rel="noopener noreferrer" title="Follow us on Instagram" className="instagram-link">
